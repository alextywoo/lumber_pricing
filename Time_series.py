...
prophet_data_train = train[['Date', 'Market_Price']].rename(columns={'Date': 'ds', 'Market_Price': 'y'})
...
prophet_model = Prophet(
    ...
    uncertainty_samples= results['best_params']['uncertainty_samples'],
    seasonality_mode= results['best_params']['seasonality_mode'],
